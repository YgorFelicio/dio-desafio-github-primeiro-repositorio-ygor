...
<body class="body2">
	...
	<center>
		...
		<form name="formulario" action = "insere_usu.php" method = "post">
		
			<table class="tab6">
				
				<tr><td><br></td></tr>
							
				<tr><td align="center" colspan="5"><h1 id = "titulo"> Sistema de Cadastro de Usuário</h1></td></tr>			
				
				<tr><td><br></td></tr>
								
				<tr>
					<td align="right"><br><b><h2 class="h2C">Nome: &nbsp;&nbsp;</h2></b></td>
					<td><br><input type='text' class="caixa1" name='txtNome' id='txtNome'></td>
				</tr>
				...
				<tr>
					<td align="right"><br><b><h2 class="h2C">CPF: &nbsp;&nbsp;</h2></b></td>
					<td><br><input type='text' class="caixa1" name='txtCPF' id='txtCPF' 
					onkeypress="return ValCPF(this);" maxlength="14"></td>
				</tr>
				...
				<tr>
					...
					onkeypress="return ValTel(this);"  maxlength="15"></td>
				</tr>
