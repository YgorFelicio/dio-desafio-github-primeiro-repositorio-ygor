...
<body class="body2">
	...
	<center> 
		...
		<form name="formulario" action = "login_emp.php" method = "post">
		
			<table class="tab5">
			
				<tr><td><br></td></tr>
							
				<tr><td align="center" colspan="5"><h1 id = "titulo"> Área de login/cadastro de empresa</h1></td></tr>			
				...
				<tr><td align="center" colspan="5"><?php echo "<a href='cadastrar_emp.php' class='botao1'> Cadastrar-se</a>";?></td></tr>
